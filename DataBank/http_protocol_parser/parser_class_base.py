...
class HttpRequestParserBase(object):
    ...
    ''' manage '''
    def manage_metadata(self, body, token_key, callback, method, target):
        db_base_not_implement(db_util.get_current_function_name())
    def manage_setting(self, body, token_key, callback, method, target):
        db_base_not_implement(db_util.get_current_function_name())
    def manage_bill(self, body, token_key, callback, method, target):
        db_base_not_implement(db_util.get_current_function_name())
    def manage_feedback(self, body, token_key, callback, method, target):
        db_base_not_implement(db_util.get_current_function_name())
    def manage_inquiry(self, body, token_key, callback, method, target):
        db_base_not_implement(db_util.get_current_function_name())
